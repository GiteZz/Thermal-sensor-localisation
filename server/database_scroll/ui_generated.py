...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.plotGraphicsView = QtWidgets.QGraphicsView(self.centralwidget)
        self.plotGraphicsView.setObjectName("plotGraphicsView")
        self.rightVLayout.addWidget(self.plotGraphicsView)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.backwardMoreButton.setText(_translate("MainWindow", "<<< (1s)"))
        self.backwardOneButton.setText(_translate("MainWindow", "< (0.25s)"))
        self.forwardOneButton.setText(_translate("MainWindow", "(0.25s) > "))
        self.forwardMoreButton.setText(_translate("MainWindow", "(1s) >>>"))
