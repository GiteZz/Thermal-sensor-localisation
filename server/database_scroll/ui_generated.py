...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.csvHLayout.addWidget(self.saveCSVFRAMEButton)
        ...
        self.csvList = QtWidgets.QListWidget(self.centralwidget)
        self.csvList.setObjectName("csvList")
        self.verticalLayout_2.addWidget(self.csvList)
